...
export default class AdminPanel extends Component {
  ...
  handleProductSubmit = (e) => {
    ...
    if (selectedProductId) {
      axios.patch(`http://localhost:8080/products/${selectedProductId}`, { productName, price, stock, categoryId })
        .then(response => {
      ...
      axios.post('http://localhost:8080/products', { productName, categoryId, price,stock })
        .then(response => {
  ...
  handleCategorySubmit = (e) => {
    ...
    if (selectedCategoryId) {
      axios.patch(`http://localhost:8080/categories/${selectedCategoryId}`, { categoryName })
        .then(response => {
